...
#cloud watch
PolicyARN1=(`aws autoscaling put-scaling-policy --policy-name policy-1 --auto-scaling-group-name itmo-autoscaling-group --scaling-adjustment 1 --scaling-adjusment-type ChangeInCapacity`);
